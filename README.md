...
<table cellpadding="0" cellspacing="0" style="border:none;">
  <tr>
    <td style="border:none;" align="right">
      <img 
        src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExZDFjMTZxY3BxZDAzanZ2emo4ZXNkNHd4dmtpc3Byc2NobnFsZThrayZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/GFLB1pCmhgvIDSJTvp/giphy.gif"
...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Asumiz&layout=compact&card_width=300&cache_seconds=10)
...
- 🧠 **Currently studying:** Cybersecurity (FATEC – São Paulo, Brazil)  
- 🏢 **Current role:** Cybersecurity Intern — **Data Protection (DAM) & PAM**  
- 🔐 **Main focus:** IBM Guardium GDP & Secret Server (PAM)

    </td>
    <td style="border:none;" align="right">
      <img 
        src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExN3IxM2d5dG5sbzBqZTBlYTc4MWk2NjExNHNvOHUzY2Q1ajZiOWhmYiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/077i6AULCXc0FKTj9s/giphy.gif"
        alt="Cyber terminal animation"
        width="240"/>
    </td>
  </tr>
</table>
...
### 🔒 Data Protection & PAM
- IBM Guardium GDP (Collectors & Central Manager)
- Must Gather & advanced CLI diagnostics
- Custom audit and compliance reports
- Buffer usage analysis and collection quality
- Secret Server (PAM): vaults, credentials, roles, workflows

### 🌐 Infrastructure & Networking
- Routing & Switching (CCNA-level)
- Secure network segmentation
- Firewall concepts and access control
- VMware Workstation Pro (labs & environments)

### ☁️ Cloud & Identity
- AWS, Azure and Google Cloud fundamentals
- IAM best practices
- Encryption and secure architectures
- Hybrid and on-prem → cloud migration support

### 🤖 Automation & Scripting
- Automation of security routines
- Custom scripts and bundles for Guardium
- Cross-OS adaptations
- Process optimization for security teams

---
## 🤝 How I Can Help on Projects
<table cellpadding="0" cellspacing="0" style="border:none;">
  <tr>
    <td style="border:none;" align="right">
      <img 
...
Focused on **enterprise cybersecurity**, **data protection**, and **scalable secure architectures**, always improving automation, visibility, and resilience in complex environments.
